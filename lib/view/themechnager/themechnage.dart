...
import 'package:mvvmwithprovider/view/notifylistnerscreen/notifylistnerscreen.dart';
    ...
    return Scaffold(
      body: SafeArea(
        ...
        children: [
          ...
          RadioListTile<ThemeMode>(
            title: const Text("Sysytem theme"),
          ...
          ElevatedButton(
              ...
              child: const Text("Notify listener sample"))
        ],
      )),
    );
  }
